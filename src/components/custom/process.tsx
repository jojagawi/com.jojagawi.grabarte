...
const steps = [
  {
    ...
    description: "Escríbenos qué producto necesitas, para qué ocasión y comparte tus ideas o imágenes de referencia.",
    icon: MessageSquare,
    color: "#4290A3",
  },
  {
    ...
    description: "Nuestro equipo crea una propuesta de diseño. Tú apruebas o sugieres cambios hasta que quede perfecto.",
    icon: Palette,
    color: "#1FA4A7",
  },
  {
    number: "03",
    title: "Producción",
    description: "Con tu aprobación, comenzamos la producción con tecnología láser de alta precisión.",
    icon: Package,
    color: "#3ACBFE",
  },
  {
    number: "04",
    title: "Entrega",
    description: "Empacamos con cuidado y enviamos a cualquier parte de México. También puedes recoger en persona.",
    icon: Truck,
    color: "#00B003",
  },
]
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/80">
                No importa si es un regalo único o 500 piezas para tu evento. ¡Estamos listos!
              </p>
            </div>
